...
#Encoder
x=Conv2D(32,(3,3),activation='relu',padding='same')(input_img)  #32x32x32
...
x=Conv2D(32,(3,3),activation='relu',padding='same')(x)  #8x8x32
encoded=MaxPooling2D((2,2),padding='same',name='encoder')(x)  #latent vector 4x4x32

#Decoder
x=Conv2DTranspose(32,(3,3),strides=(2,2),activation='relu',padding='same')(encoded) #8x8x32
x=Conv2DTranspose(32,(3,3),strides=(2,2),activation='relu',padding='same')(x) #16x16x32
