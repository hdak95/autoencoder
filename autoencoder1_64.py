...
encoded=MaxPooling2D((2,2),padding='same',name='encoder')(x)  #latent vector 8x8x64

#Decoder
x=Conv2DTranspose(64,(3,3),strides=(2,2),activation='relu',padding='same')(encoded) #16x16x64
